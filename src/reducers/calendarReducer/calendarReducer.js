...
const { setDate, setMonthName, getDaysInMonth } = helper

const calendarReducer = (state, action) => {
    const { year, month, day, initialDay, date } = state
    ...
    switch (action.type) {
        case GET_NEXT_MONTH: {
            ...
            return {...state, date: newDate, month: nextMonth, monthName: setMonthName(newDate), initialDay: newDate.getDay(), daysInCurrentMonth}
        }
        case GET_PREVIOUS_MONTH: {
            ...
            return {...state, date: newDate, month: prevMonth, monthName: setMonthName(newDate), initialDay: newDate.getDay(), daysInCurrentMonth}
        }
    }
}
